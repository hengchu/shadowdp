...
do
   ...
   ./cpachecker/scripts/cpa.sh -predicateAnalysis $filename -preprocess
   echo -e "\033[92mChecking \033[1m$filename\033[0m \033[92mwith \033[31;1mSMT-Interpol\033[0m"
   ./cpachecker/scripts/cpa.sh -predicateAnalysis $filename -preprocess -setprop solver.solver=smtinterpol
   echo -e "\033[92mChecking \033[1m$filename\033[0m \033[92mwith \033[31;1mZ3\033[0m"
   ./cpachecker/scripts/cpa.sh -predicateAnalysis $filename -preprocess -setprop solver.solver=z3
done
