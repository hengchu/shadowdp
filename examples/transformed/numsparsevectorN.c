...
int numsparsevectorN(float epsilon, int size, float q[], float T, float NN, float __SHADOWDP_ALIGNED_DISTANCE_q[], float __SHADOWDP_SHADOW_DISTANCE_q[])
{
  ...
  __SHADOWDP_v_epsilon = __SHADOWDP_v_epsilon + (0.333333333333333 * NN);
  float T_bar = T + eta_1;
  float count = 0;
  int i = 0;
